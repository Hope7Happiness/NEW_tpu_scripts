...
pip download 'jax[tpu]==0.4.37' -f https://storage.googleapis.com/jax-releases/libtpu_releases.html # this is only for tpu libs
rm jaxlib-0.4.36-cp310-cp310-manylinux2014_x86_64.whl jax-0.4.37-py3-none-any.whl ml_dtypes-0.5.3-cp310-cp310-manylinux_2_27_x86_64.manylinux_2_28_x86_64.whl numpy-2.2.6-cp310-cp310-manylinux_2_17_x86_64.manylinux2014_x86_64.whl # remove jax (will re-install later)
...
pip download msgpack==1.1.2 pyyaml==5.4.1 protobuf==4.21.12 etils==1.13.0 numpy==1.26.4 humanize==4.13.0 typing-extensions==4.15.0 nest_asyncio==1.6.0 zipp==1.0.0 jaxlib==0.4.34 jax==0.4.34 absl-py==2.3.1 opt-einsum==3.4.0 scipy==1.15.3 fsspec==2025.9.0 importlib_resources==6.5.2 ml-dtypes==0.5.0 tensorstore==0.1.67 orbax-checkpoint==0.6.4 humanize==4.13.0
...
pip download jax==0.4.34 huggingface-hub==0.35.3 h5py==3.14.0 flax==0.10.4 pyyaml==5.4.1 rich==14.1.0 typing-extensions==4.15.0 tensorstore==0.1.67 msgpack==1.1.2 treescope==0.1.10 orbax-checkpoint==0.6.4 optax==0.2.5 scipy==1.15.3 jaxlib==0.4.34 opt-einsum==3.4.0 ml-dtypes==0.5.0 numpy==1.26.4 pillow==11.3.0 requests==2.32.3 tqdm==4.67.1 regex==2025.9.18 packaging==21.3 filelock==3.16.1 hf-xet==1.1.10 fsspec==2025.9.0 charset-normalizer==3.4.0 certifi==2020.6.20 idna==3.3 urllib3==2.5.0 markdown-it-py==4.0.0 pygments==2.19.2 chex==0.1.90 absl-py==2.3.1 humanize==4.13.0 etils==1.13.0 protobuf==4.21.12 nest_asyncio==1.6.0 toolz==1.0.0 mdurl==0.1.2 zipp==1.0.0 importlib_resources==6.5.2 dataclasses==0.6 flaxmodels==0.1.3 lpips-j==0.0.6
...
cd ..
tar -czvf v6_wheels.tar.gz wheels
gsutil -m cp -r ./v6_wheels.tar.gz gs://kmh-gcp-us-east1/hanhong/v6_wheels.tar.gz