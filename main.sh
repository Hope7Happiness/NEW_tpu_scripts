...
# source .ka
no_need_check=$(
    [[ "$1" == "s" || "$1" == "wall" || ("$1" == "w" && "$2" == "all") || "$1" == "dall" || ("$1" == "d" && "$2" == "all") || ("$1" == "c") || ("$1" == "kill") || ("$1" == "submit") || ("$1" == "change") || ("$1" == "delete") || ("$1" == "table") || ("$1" == "center") || ("$1" == "center-worker") || ("$1" == "center-probe") || ("$1" =~ ^h) ]] \
...
if $no_need_check || check_config_sanity; then
    if [ "$1" = "rr" ]; then
        ...
        python3 "$ZHH_SCRIPT_ROOT/tpu_center/cli.py" delete "$2"
    elif [ "$1" = "table" ]; then
        python3 "$ZHH_SCRIPT_ROOT/tpu_center/cli.py" table "${@:2}"
    elif [ "$1" = "center" ]; then
        python3 "$ZHH_SCRIPT_ROOT/tpu_center/cli.py" "${@:2}"
    elif [ "$1" = "center-worker" ]; then
        zcenter_worker "${@:2}"
